...
import type { AddDisciplina, CheckDisciplinaById, GetDisciplinaById, LoadDisciplina, RemoveDisciplina, UpdateDisciplina } from '../../domain/usecases'
...
export class GetDisciplinaByIdSpy implements GetDisciplinaById {
  id: number
